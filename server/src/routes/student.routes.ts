...
const createValidation = [
  ...
  body('dateOfBirth').optional({ checkFalsy: true }).isISO8601().withMessage('dateOfBirth không hợp lệ'),
  ...
  body('course').optional({ checkFalsy: true }).isString().withMessage('course không hợp lệ'),
  body('emergencyContact').optional({ checkFalsy: true }).isString().withMessage('emergencyContact không hợp lệ'),
  body('emergencyPhone').optional({ checkFalsy: true }).isString().withMessage('emergencyPhone không hợp lệ'),
